...
class AlumnoService:
    ...
    @staticmethod
    def buscar_por_id(id: int) -> Optional[Alumnos]:
    ...
    @staticmethod
    def actualizar(id: int, alumno: Alumnos) -> Optional[Alumnos]:
    ...
    @staticmethod
    def _tipo_doc_sigla_safe(alumno: Alumnos) -> str:
    ...
    @staticmethod
    def _contexto_certificado(alumno: Alumnos) -> dict:
        """
